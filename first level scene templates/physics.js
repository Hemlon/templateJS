...
var level1 = function() {
	...
	//add  ball
		gameObjs.add(new sprite("ball",200,50,44,"pics/coin_anim.png",10, 2,false,"CIRCLE")); 
		var ball = gameObjs.get("ball").body;
		ball.restitution = 0.9; //how bouncey the ball is 
		ball.friction = 0; //how much friction
	
		gameObjs.add(new gameObj("box", 400,300,50,50,false, "RECT"));
		gameObjs.add(new gameObj("ground",400,610,810,60, true, "RECT")); 
